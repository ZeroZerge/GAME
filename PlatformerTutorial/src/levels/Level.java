...
public class Level {
	...
	private void loadLevelData(int redValue, int x, int y) {
		...
		switch (redValue) {
		case 0:case 1:case 2:case 3:case 30:case 31:case 33:case 34:case 35:case 36:case 37:case 38: case 39: 
	...
	private void loadObjects(int blueValue, int x, int y) {
		switch (blueValue) {
		case RED_POTION:case BLUE_POTION : potions.add(new Potion(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue)); break;
		case BOX: case BARREL : containers.add(new GameContainer(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue)); break;
		case SPIKE : spikes.add(new Spike(x * Game.TILES_SIZE, y * Game.TILES_SIZE, SPIKE)); break;
		case CANNON_LEFT:case CANNON_RIGHT : cannons.add(new Cannon(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue)); break;
		case TREE_ONE: case TREE_TWO: case TREE_THREE : trees.add(new BackgroundTree(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue)); break;
		}
	}
